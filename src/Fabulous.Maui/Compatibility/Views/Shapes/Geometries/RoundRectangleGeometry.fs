...
type IFabCompatRoundRectangleGeometry =
    inherit IFabCompatGeometryGroup

module RoundRectangleGeometry =

    let WidgetKey = CompatWidgets.register<RoundRectangleGeometry>()
...
module RoundRectangleGeometryBuilders =
    type Fabulous.Maui.View with
        ...
        static member inline RoundRectangleGeometry<'msg>(cornerRadius: float, rect: Rect) =
            WidgetBuilder<'msg, IFabCompatRoundRectangleGeometry>(
...
type RoundRectangleGeometryModifiers =
    ...
    [<Extension>]
    static member inline fillRule(this: WidgetBuilder<'msg, #IFabCompatRoundRectangleGeometry>, value: FillRule) =
