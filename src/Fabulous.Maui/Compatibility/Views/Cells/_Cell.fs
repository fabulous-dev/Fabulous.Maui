...
type CellModifiers =
    ...
    [<Extension>]
    static member inline isEnabled(this: WidgetBuilder<'msg, #IFabCompatCell>, value: bool) =
    ...
    [<Extension>]
    static member inline height(this: WidgetBuilder<'msg, #IFabCompatCell>, value: float) =
        this.AddScalar(Cell.Height.WithValue(value))

    [<Extension>]
    static member inline onAppearing(this: WidgetBuilder<'msg, #IFabCompatCell>, onAppearing: 'msg) =
        this.AddScalar(Cell.Appearing.WithValue(onAppearing))

    [<Extension>]
    static member inline onDisappearing(this: WidgetBuilder<'msg, #IFabCompatCell>, onDisappearing: 'msg) =
        this.AddScalar(Cell.Disappearing.WithValue(onDisappearing))

    [<Extension>]
    static member inline onTapped(this: WidgetBuilder<'msg, #IFabCompatCell>, onTapped: 'msg) =
