...
type IFabCompatSwitchCell =
    inherit IFabCompatCell

module SwitchCell =
    let WidgetKey = CompatWidgets.register<SwitchCell>()
...
module SwitchCellBuilders =
    type Fabulous.Maui.View with
        ...
        static member inline SwitchCell<'msg>(text: string, value: bool, onChanged: bool -> 'msg) =
            WidgetBuilder<'msg, IFabCompatSwitchCell>(
...
type SwitchCellModifiers =
    ...
    [<Extension>]
    static member inline colorOn(this: WidgetBuilder<'msg, #IFabCompatSwitchCell>, light: FabColor, ?dark: FabColor) =
    ...
    [<Extension>]
    static member inline reference(this: WidgetBuilder<'msg, IFabCompatSwitchCell>, value: ViewRef<SwitchCell>) =
