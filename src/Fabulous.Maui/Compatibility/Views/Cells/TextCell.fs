...
type IFabCompatTextCell =
    inherit IFabCompatCell

module TextCell =
    let WidgetKey = CompatWidgets.register<TextCell>()
...
module TextCellBuilders =
    type Fabulous.Maui.View with
        ...
        static member inline TextCell<'msg>(text: string) =
            WidgetBuilder<'msg, IFabCompatTextCell>(TextCell.WidgetKey, TextCell.Text.WithValue(text))
...
type TextCellModifiers =
    ...
    [<Extension>]
    static member inline textColor(this: WidgetBuilder<'msg, #IFabCompatTextCell>, light: FabColor, ?dark: FabColor) =
    ...
    /// <param name="dark">The color of the text in the dark theme.</param>
    [<Extension>]
    static member inline detailColor(this: WidgetBuilder<'msg, #IFabCompatTextCell>, light: FabColor, ?dark: FabColor) =
    ...
    [<Extension>]
    static member inline detailText(this: WidgetBuilder<'msg, #IFabCompatTextCell>, text: string) =
    ...
    [<Extension>]
    static member inline reference(this: WidgetBuilder<'msg, IFabCompatTextCell>, value: ViewRef<TextCell>) =
