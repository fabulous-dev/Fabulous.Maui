...
type IFabCompatWebView =
    inherit IFabCompatView
    inherit IWebView

module WebView =

    let WidgetKey = CompatWidgets.register<WebView>()
...
module WebViewBuilders =
    type Fabulous.Maui.View with
        ...
        static member inline WebView<'msg>(source: WebViewSource) =
            WidgetBuilder<'msg, IFabCompatWebView>(WebView.WidgetKey, WebView.Source.WithValue(source))
...
type WebViewModifiers() =
    ...
    [<Extension>]
    static member inline canGoBack(this: WidgetBuilder<'msg, #IFabCompatWebView>, value: bool) =
    ...
    [<Extension>]
    static member inline canGoForward(this: WidgetBuilder<'msg, #IFabCompatWebView>, value: bool) =
    ...
    [<Extension>]
    static member inline cookies(this: WidgetBuilder<'msg, #IFabCompatWebView>, value: CookieContainer) =
        this.AddScalar(WebView.Cookies.WithValue(value))

    [<Extension>]
    static member inline onNavigating(this: WidgetBuilder<'msg, #IFabCompatWebView>, onNavigating: WebNavigatingEventArgs -> 'msg) =
        this.AddScalar(WebView.Navigating.WithValue(fun args -> onNavigating args |> box))

    [<Extension>]
    static member inline onNavigated(this: WidgetBuilder<'msg, #IFabCompatWebView>, onNavigated: WebNavigatedEventArgs -> 'msg) =
    ...
    [<Extension>]
    static member inline reference(this: WidgetBuilder<'msg, IFabCompatWebView>, value: ViewRef<WebView>) =
        this.AddScalar(ViewRefAttributes.ViewRef.WithValue(value.Unbox))

[<Extension>]
type WebViewPlatformModifiers =
    [<Extension>]
    static member inline enableZoomControls(this: WidgetBuilder<'msg, #IFabCompatWebView>, value: bool) =
        this.AddScalar(WebView.EnableZoomControls.WithValue(value))

    [<Extension>]
    static member displayZoomControls(this: WidgetBuilder<'msg, #IFabCompatWebView>, value: bool) =
