...
module DatePickerBuilders =
    type Fabulous.Maui.View with
        ...
        static member inline DatePicker<'msg>(date: DateTime, onDateSelected: DateTime -> 'msg) =
            WidgetBuilder<'msg, IFabCompatDatePicker>(
...
type DatePickerModifiers =
    ...
    [<Extension>]
    static member inline characterSpacing(this: WidgetBuilder<'msg, #IFabCompatDatePicker>, value: float) =
        this.AddScalar(DatePicker.CharacterSpacing.WithValue(value))

    [<Extension>]
    static member inline font
        (
            this: WidgetBuilder<'msg, #IFabCompatDatePicker>,
            ?size: float,
    ...
    [<Extension>]
    static member inline format(this: WidgetBuilder<'msg, #IFabCompatDatePicker>, value: string) =
    ...
    [<Extension>]
    static member inline minimumDate(this: WidgetBuilder<'msg, #IFabCompatDatePicker>, value: DateTime) =
    ...
    [<Extension>]
    static member inline maximumDate(this: WidgetBuilder<'msg, #IFabCompatDatePicker>, value: DateTime) =
    ...
    [<Extension>]
    static member inline textColor(this: WidgetBuilder<'msg, #IFabCompatDatePicker>, light: FabColor, ?dark: FabColor) =
    ...
    [<Extension>]
    static member inline reference(this: WidgetBuilder<'msg, IFabCompatDatePicker>, value: ViewRef<DatePicker>) =
...
type DatePickerPlatformModifiers =
    ...
    [<Extension>]
    static member inline updateMode(this: WidgetBuilder<'msg, #IFabCompatDatePicker>, mode: iOSSpecific.UpdateMode) =
