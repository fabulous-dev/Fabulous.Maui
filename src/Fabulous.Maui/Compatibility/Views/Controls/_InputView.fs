...
type InputViewModifiers =
    ...
    [<Extension>]
    static member inline characterSpacing(this: WidgetBuilder<'msg, #IFabCompatInputView>, value: float) =
    ...
    [<Extension>]
    static member inline isReadOnly(this: WidgetBuilder<'msg, #IFabCompatInputView>, value: bool) =
    ...
    [<Extension>]
    static member inline isSpellCheckEnabled(this: WidgetBuilder<'msg, #IFabCompatInputView>, value: bool) =
    ...
    [<Extension>]
    static member inline placeholder(this: WidgetBuilder<'msg, #IFabCompatInputView>, value: string) =
    ...
    [<Extension>]
    static member inline placeholderColor(this: WidgetBuilder<'msg, #IFabCompatInputView>, light: FabColor, ?dark: FabColor) =
    ...
    [<Extension>]
    static member inline textColor(this: WidgetBuilder<'msg, #IFabCompatInputView>, light: FabColor, ?dark: FabColor) =
    ...
    [<Extension>]
    static member inline keyboard(this: WidgetBuilder<'msg, #IFabCompatInputView>, value: Keyboard) =
    ...
    [<Extension>]
    static member inline maxLength(this: WidgetBuilder<'msg, #IFabCompatInputView>, value: int) =
        this.AddScalar(InputView.MaxLength.WithValue(value))

    [<Extension>]
    static member inline textTransform(this: WidgetBuilder<'msg, #IFabCompatInputView>, value: TextTransform) =
