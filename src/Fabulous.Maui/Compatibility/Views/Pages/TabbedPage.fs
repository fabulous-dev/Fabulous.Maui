...
type IFabCompatTabbedPage =
    inherit IFabCompatMultiPageOfPage

module TabbedPage =
    let WidgetKey = CompatWidgets.register<TabbedPage>()
...
module TabbedPageBuilders =
    type Fabulous.Maui.View with
        ...
        static member inline TabbedPage<'msg>(title: string) =
            CollectionBuilder<'msg, IFabCompatTabbedPage, IFabCompatPage>(TabbedPage.WidgetKey, MultiPageOfPage.Children, Page.Title.WithValue(title))
...
type TabbedPageModifiers =
    ...
    [<Extension>]
    static member inline barBackgroundColor(this: WidgetBuilder<'msg, #IFabCompatTabbedPage>, light: FabColor, ?dark: FabColor) =
    ...
    [<Extension>]
    static member inline barTextColor(this: WidgetBuilder<'msg, #IFabCompatTabbedPage>, light: FabColor, ?dark: FabColor) =
    ...
    [<Extension>]
    static member inline selectedTabColor(this: WidgetBuilder<'msg, #IFabCompatTabbedPage>, light: FabColor, ?dark: FabColor) =
    ...
    [<Extension>]
    static member inline unselectedTabColor(this: WidgetBuilder<'msg, #IFabCompatTabbedPage>, light: FabColor, ?dark: FabColor) =
    ...
    [<Extension>]
    static member inline reference(this: WidgetBuilder<'msg, IFabCompatTabbedPage>, value: ViewRef<TabbedPage>) =
...
type TabbedPagePlatformModifiers =
    ...
    [<Extension>]
    static member inline toolbarPlacement(this: WidgetBuilder<'msg, #IFabCompatTabbedPage>, value: ToolbarPlacement) =
