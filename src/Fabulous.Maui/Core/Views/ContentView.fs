...
module ContentView =
    ...
    let PresentedContent = Attributes.defineMauiPropertyWidget "Content" (fun (target: IFabContentView) -> target.PresentedContent)  (fun target -> target.SetPresentedContent)
